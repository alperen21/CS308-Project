...
import { SmInvoice,Invoice,AddProduct,Return,Rate, OrderDetail, PmPage, PrevDetail,PrevOrders, Charts, Products, Navbar1, Login, Register,Espressos, Filter_coffee_products, Espresso_machines,Hot_chocolates,Turkish_coffees, Cart, Product_Detail, Checkout, Profile} from './components';
